...
import Svg, {Image, Circle, CliPath} from 'react-native-svg'
      ...
      <View
       style={{flex: 1, backgroundColor: 'white', justifyContent: 'flex-end'}}>
          ...
          <Svg height={height} width={width}>
                          <Image
                href={require('../assets/image/water-drop.jpg')}
               width={width}
               height={height}
           ...
           <TapGestureHandler onHandlerStateChange={this.onStateChange}>
              ...
              opacity:this.buttonOpacity, transform:[{translateY:this.buttonY}]}}>
                  <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white'}}>SIGN IN WHIT FACEBOOK</Text>
              </Animated.View>
